  ...
  const jsonLd = [
    {
      ...
      description:
        "Best anti-termite treatment company in India. Pre & post construction termite treatment (dimak ka ilaj), porous pipe installation, chemical injection, and annual maintenance. 10+ years experience, 1000+ happy customers.",
      hasOfferCatalog: {
        "@type": "OfferCatalog",
